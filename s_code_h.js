...
if(u.indexOf('snapsbywalgreens.com')>-1)
	s_account="walgrns"; 
/*Added for EO-19559  End */
if(u.indexOf('walgreens.com')>-1)
	s_account="walgrns";
if(u.indexOf('photo.walgreens.com')>-1)
	s_account="walgrns";	
if(u.indexOf('photo1.walgreens.com')>-1)
	s_account="walgrns";
if(u.indexOf('photo2.walgreens.com')>-1)
	s_account="walgrns";	
if(u.indexOf('dwagdb01')>-1)
	s_account="devwalgrns";
if(u.indexOf('wgus5.qa.snapfish.com')>-1)
	s_account="devwalgrnsstaging";
if(u.indexOf('ecomcsrstg.walgreens.com/CSR')>-1)
	s_account="walgrnscsrstaging";
if(u.indexOf('ecstgweb.walgreensoutreach.com')>-1)
	s_account="devwalgrnsstaging";
if(u.indexOf('ecstgweb')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('ecstgweb3')>-1)
	s_account="devwalgrnsstaging";
if(u.indexOf('www2.walgreens.com')>-1)
	s_account="walgrnstest";
if(u.indexOf('www3.walgreens.com')>-1)
	s_account="walgrnstest";
if(u.indexOf('ecomcsr.walgreens.com/CSR')>-1)
	s_account="walgrnscsr";	
if(u.indexOf('worksite.walgreens.com')>-1)
	s_account="walgrnsworksite";
if(u.indexOf('TakeCareHealth.com')>-1)
	s_account="walgrnstakecare";
if(u.indexOf('mywalgreens.walgreens.com')>-1)
	s_account="devwalgrns";	
if(u.indexOf('mycomputer.walgreens.com')>-1)
	s_account="devwalgrns";
if(u.indexOf('wgus1.qa.snapfish.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa1.walgreens.com')>-1)
	s_account="devwalgrnsstaging";
if(u.indexOf('qa.prodfix.walgreens.com')>-1)
	s_account="devwalgrnsstaging";
if(u.indexOf('qa2.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa3.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa4.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa5.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa6.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa7.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa8.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa9.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('qa10.walgreens.com')>-1)
	s_account="devwalgrnsstaging";
if(u.indexOf('qa10.walgreens.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('www.walgreensoutreach.com')>-1)
	s_account="walgrns";		
if(u.indexOf('qa1.walgreensoutreach.com')>-1)
	s_account="devwalgrnsstaging";	
if(u.indexOf('web.qa.walgreensrewards.com')>-1)
	s_account="walgrnsloyaltytest";	
if(u.indexOf('www.walgreensrewards.com')>-1)
	s_account="walgrnsloyalty";
if(u.indexOf('webpickup.walgreens.com')>-1)
	s_account="walgrns,walgrnsquickshop";
if(u.indexOf('qa1-webpickup.walgreens.com')>-1)
	s_account="walgrnsquickshopdev";
if(u.indexOf('discoverbeautywithin.com')>-1) 
	s_account="walgrns";
if(u.indexOf('e3533.b.akamaiedge.net')>-1)
	s_account="walgrns";
/*EO-17872 Update S_Code to allow tracking of new Folded Words Microsite START */
if(u.indexOf('bloom.pnidev.com')>-1)
	s_account="walgrnsfoldedwordsstage";
if(u.indexOf('bloom.pniqa.com')>-1)
	s_account="walgrnsfoldedwordsstage";
...
if(u.indexOf('walgreens.eqal.com')>-1)
	s_account="walgrns"; 
if(u.indexOf('employeewalk.walgreens.com')>-1) 
	s_account="walgrns"; 
if(u.indexOf('walk.walgreens.com')>-1) 
	s_account="walgrns"; 
/*Added for EO-12569  End */
/*Added for EO-21604  Start */
...
s.linkInternalFilters="javascript:,walgreens.com,walgreensenespanol.com,walgreensenspanol.com,walgreensespanol.com,walgreensinspanish.com,walgreensspanish.com,walgreensphotocenter.com,wal-green.com,walgrens.com,walgreen.com,walgreenpharmacy.com,wal-greens.com,walgreens.net,wal-gren.com,wal-grens.com,wallgreens.com,wallgreen.com,wgus9.qa.snapfish.com,wgus11.qa.snapfish.com,walgreens.jobs,wgus1.qa.snapfish.com,wgus3.qa.snapfish.com"
...
function s_doPlugins(s) 
{
	...
	if(!s.campaign)
		s.campaign=s.getQueryParam('rem');
	if(!s.campaign)
		s.campaign=s.getQueryParam('rxr');
	if(!s.campaign)
		s.campaign=s.getQueryParam('ec');
	if(!s.campaign)
		s.campaign=s.getQueryParam('ext');
	if(!s.campaign)
		s.campaign=s.getQueryParam('ols');
	if(!s.campaign)
	...
	if(!s.eVar3)
		s.eVar3=s.getQueryParam('area');
	if(!s.eVar4)
		s.eVar4=s.getQueryParam('swp');
	if(!s.eVar5)
		s.eVar5=s.getQueryParam('term');
	if(!s.eVar22)
		s.eVar22=s.getQueryParam('erule');		
	    /* EO-18967 Added s.eVar62 */
	    s.eVar62=s.getQueryParam('adtype'); 
	if(!s.eVar23)
		s.eVar23=s.getQueryParam('tab');
	if(!s.eVar31)
		s.eVar31=s.getQueryParam('foot');
	/*EO-20043-Added rkg_id query param as part of this ticket*/ 
	if(!s.eVar60)
		s.eVar60=s.getQueryParam('rkg_id');	

	/*Kenshoo Click ID*/ 
	if(s.getQueryParam('sst') !="")
	       s.eVar48=s.getQueryParam('sst'); 
	
	/*CJ AID*/ 
	if(s.getQueryParam('AID') !="")
	       s.eVar49=s.getQueryParam('AID'); 

	/*CJ PID*/ 
	if(s.getQueryParam('PID') !="") 
	       s.eVar50=s.getQueryParam('PID'); 

	/*CJ CID*/ 
	if(s.getQueryParam('SID') !="")
	       s.eVar27=s.getQueryParam('SID'); 

	/*CA ID*/ 
	if(s.getQueryParam('CAID') !="")
	       s.eVar28=s.getQueryParam('CAID');

	// Facebook & Twitter - Tracking SOC Param
	if(s.getQueryParam('soc') != "") {
	    s.eVar58 = s.getQueryParam('soc');
	}

	/* Check if varible is already declared */
	function isAvlb(x) {
		return x in window;
	}
	/*Migrate g code variables over to h code */
	...
	if(s.getQueryParam('erule') != "") {
		s.eVar5 = s.getQueryParam('erule');
	}
	...
	//EO-19100 Starts : Modifying Omniture S_Code for Google SSL Changes
...
/*NOTE: UNCOMMENT OUT THE FOLLOWING THREE LINES WHEN 1ST PARTY COOKIES GO LIVE! */
...
//EO-25453: Starts :Update s_code_h.js getQueryParam plugin to v2.4
/*
...
+"epa(v)}return''");
//EO-25453: Ends :Update s_code_h.js getQueryParam plugin to v2.4
